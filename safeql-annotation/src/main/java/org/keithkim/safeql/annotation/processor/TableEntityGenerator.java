...
//    }
        ...
        String quotedNames = Utils.join(", ", constructorParams.keySet().stream()
                .map((String s) -> Utils.quote(s)).collect(Collectors.toList()));
        String unquotedNames = Utils.join(", ", constructorParams.keySet());
